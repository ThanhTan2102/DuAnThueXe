...
//            barChart = bdhd.createBarChart();
    ...
    private void initComponents() {
        ...
        jDateChooser2.setPreferredSize(new java.awt.Dimension(88, 27));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoanhThuHoaDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
